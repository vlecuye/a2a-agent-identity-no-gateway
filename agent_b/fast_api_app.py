"""FastAPI application for Agent B.
...
from agent_b.agent import app as agent_app

# Build the base FastAPI application for the ADK agent
app = get_fast_api_app(agent_app=agent_app, web=True)

# Attach A2A routes (/a2a/agent_b/.well-known/agent-card.json and JSON-RPC message handlers)
try:
